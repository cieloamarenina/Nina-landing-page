...
|---|---|---|
| `page-visit-workflow.json` | Telegram-Push bei jedem Page-Visit | `POST /webhook/page-visit-easycosmetic` |
| `qr-workflow.json` | Server-side QR-Code-Generation | `GET /webhook/qr-easycosmetic` |
| `cv-download-workflow.json` | CV-PDF-Lieferung mit Telegram-Push bei Download | `GET /webhook/cv-easycosmetic` |
...
```
https://n8n.ninalearnsvibecoding.com/webhook/page-visit-easycosmetic
https://n8n.ninalearnsvibecoding.com/webhook/qr-easycosmetic
https://n8n.ninalearnsvibecoding.com/webhook/cv-easycosmetic
```
...
```js
const CONFIG = {
  TRACKING_WEBHOOK:  'https://n8n.ninalearnsvibecoding.com/webhook/page-visit-easycosmetic',
  CAL_LINK:          'https://cal.ninalearnsvibecoding.com/nina/30min?embed=true&theme=dark',
  CV_DOWNLOAD_URL:   'https://n8n.ninalearnsvibecoding.com/webhook/cv-easycosmetic',
  QR_API_URL:        'https://n8n.ninalearnsvibecoding.com/webhook/qr-easycosmetic',
  CV_URL:            './cv-nina-panknin.pdf',
  PAGE_URL:          'https://ninalearnsvibecoding.com/bewerbung/easycosmetic/',
  MUSIC_URL:         '',
  MUSIC_VOLUME:      0.18
};
```
...
```
Nina-landing-page/bewerbung/easycosmetic/cv-nina-panknin.pdf
```

**Wichtig:** Der CV-Download-Workflow holt die PDF per HTTP-Request von der Live-URL, also die PDF muss nach dem Coolify-Deploy unter `https://ninalearnsvibecoding.com/bewerbung/easycosmetic/cv-nina-panknin.pdf` erreichbar sein.
...
Mit den drei n8n-Workflows gibst du easycosmetic ein **Demo-Live-System**:

| Aktion | Was passiert |
|---|---|
| Sie öffnen die Seite | 🔥 *„easycosmetic-Bewerbung gerade geöffnet!"* — Telegram-Push an Nina |
| Sie scrollen weiter | Visitor-Counter erhöht sich, weitere Visits = stille Pushs |
| Sie scannen den QR | 📥 *„CV-Download · easycosmetic"* + Source: `qr` → Telegram-Push |
| Sie klicken Download | 📥 *„CV-Download · easycosmetic"* + Source: `button` → Telegram-Push |
| Sie buchen Termin | Cal.com → eigene Notification |

**= Du weißt jederzeit, wo im Funnel sie gerade sind.** Genau das Setup, das du bei easycosmetic einbauen würdest. Live-Demo deiner Skills.
...
Erreichbar unter: `https://ninalearnsvibecoding.com/bewerbung/easycosmetic/`
...
- [ ] CV-PDF im Ordner und nach Deploy erreichbar unter `…/easycosmetic/cv-nina-panknin.pdf`
...
## 8 · Was an easycosmetic verschickt wird
...
> easycosmetic verlangt Bewerbung über ihr Karriereportal — mit Gehaltsvorstellung (**58k**), Anschreiben, CV, Zeugnissen.
